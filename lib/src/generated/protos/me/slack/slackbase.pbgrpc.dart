...
class SlackServiceClient extends $grpc.Client {
  static final _$getWorkspaces =
      $grpc.ClientMethod<$0.SKUser, $0.SKUserWorkspaces>(
          '/SlackService/getWorkspaces',
          ($0.SKUser value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.SKUserWorkspaces.fromBuffer(value));
  static final _$getUsers = $grpc.ClientMethod<$0.SKChannel, $0.SKChannelUsers>(
      '/SlackService/getUsers',
      ($0.SKChannel value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.SKChannelUsers.fromBuffer(value));
  static final _$getUserChannels =
      $grpc.ClientMethod<$0.SKUser, $0.SKUserChannels>(
  ...
  $grpc.ResponseStream<$0.SKUserWorkspaces> getWorkspaces($0.SKUser request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseStream<$0.SKChannelUsers> getUsers($0.SKChannel request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
  ...
  $grpc.ResponseStream<$0.SKUserChannels> getUserChannels($0.SKUser request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
...
abstract class SlackServiceBase extends $grpc.Service {
  ...
  SlackServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.SKUser, $0.SKUserWorkspaces>(
        'getWorkspaces',
        getWorkspaces_Pre,
        false,
        true,
        ($core.List<$core.int> value) => $0.SKUser.fromBuffer(value),
        ($0.SKUserWorkspaces value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.SKChannel, $0.SKChannelUsers>(
        'getUsers',
        getUsers_Pre,
        false,
        true,
        ($core.List<$core.int> value) => $0.SKChannel.fromBuffer(value),
        ($0.SKChannelUsers value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.SKUser, $0.SKUserChannels>(
        'getUserChannels',
        getUserChannels_Pre,
        false,
        true,
  ...
  $async.Stream<$0.SKUserWorkspaces> getWorkspaces_Pre(
      $grpc.ServiceCall call, $async.Future<$0.SKUser> request) async* {
    yield* getWorkspaces(call, await request);
  }

  $async.Stream<$0.SKChannelUsers> getUsers_Pre(
      $grpc.ServiceCall call, $async.Future<$0.SKChannel> request) async* {
  ...
  $async.Stream<$0.SKUserWorkspaces> getWorkspaces(
      $grpc.ServiceCall call, $0.SKUser request);
  $async.Stream<$0.SKChannelUsers> getUsers(
      $grpc.ServiceCall call, $0.SKChannel request);
